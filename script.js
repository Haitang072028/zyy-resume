...
const translations = {
    zh: {
        ...
        'courses.advancedMath': '高等数学',
        'courses.linearAlgebra': '线性代数',
        'courses.mlPatternRecognition': '机器学习与模式识别',
        'courses.neuralNetworks': '神经网络与深度学习',
        'courses.computerVision': '计算机视觉',
        'courses.naturalLanguage': '自然语言处理',
        'projects.title': '项目经历',
    ...
    en: {
        ...
        'courses.advancedMath': 'Advanced Mathematics',
        'courses.linearAlgebra': 'Linear Algebra',
        'courses.mlPatternRecognition': 'Machine Learning & Pattern Recognition',
        'courses.neuralNetworks': 'Neural Networks & Deep Learning',
        'courses.computerVision': 'Computer Vision',
        'courses.naturalLanguage': 'Natural Language Processing',
